...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"Broadening Max Width vs Calculation Time.csv"):{},
              }
    ...
    plot(df, xval='broadening_max_width', yval='calculation_time', title="(LDM Latest) Broadening Max Width vs Calculation Time",

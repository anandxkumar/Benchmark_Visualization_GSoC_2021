...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"Spectral points(Wstep constant) vs Calculation Time.csv"):{},
              }
    ...
    plot(df, xval='Spectral Points', yval='calculation_time', title="Spectral points(Wstep constant) vs Calculation Time",

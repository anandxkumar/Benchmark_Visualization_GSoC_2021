...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"Test_data.csv"):{},
              }
    ...
    plot(df, xval='spectral_points', yval='calculation_time', title="Spectral points(Wstep) vs Calculation Time",
        color_mapper='name', size='truncation', color_mapper_scale=False)

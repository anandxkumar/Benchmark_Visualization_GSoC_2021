...
# Getting x and y
x_voigt = df_voigt[['Complexity_voigt']]  # for mulitple columns -> df_voigt[['Complexity_voigt','lines_calculated']]
...
complexity_final_voigt = coeff[0]*df_voigt['Complexity_voigt']  # + coeff[1]*df_voigt['lines_calculated'] (if more columns)
...
df_voigt.to_csv(directory + "Final_Complex.csv", index=False)

...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"LDM_Spectrum_updated_(N_lines_constant).csv"):{},
              }
    ...
    plot(df, xval='Spectral Points', yval='calculation_time', title="LDM_Spectrum_updated_(N_lines_constant)",

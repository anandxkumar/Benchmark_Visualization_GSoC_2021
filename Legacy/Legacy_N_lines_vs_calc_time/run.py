...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"Spectrum_Legacy_n_lines_vs_calc_time.csv"):{},
              }
    ...
    plot(df, xval='lines_calculated', yval='calculation_time', title="Legacy_N_lines_vs_calc_time",
       size='wstep')

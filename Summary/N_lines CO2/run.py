...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"CO2 Nlines (wL and wG) vs Calculation Time.csv"):{},
              }
    ...
    plot(df, xval='lines_calculated', yval='calculation_time', title="(Summary) CO2 N_lines vs Calculation Time",

...
def test_plot_experiment_results_sample():
    ...
    files = {join(dirname(__file__),"Wstep vs Calculation Time.csv"):{},
              }
    ...
    plot(df, xval='Spectral Points', yval='calculation_time', title="(Summary) Spectral Points(Wstep) vs Calculation Time",
